document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!canvas) {
        console.error("Canvas element #cuteCanvas not found for spec.js!");
        return;
    }
    const ctx = canvas.getContext('2d');
    if (!ctx) {
        console.error("Failed to get 2D context for spec.js!");
        return;
    }
    let particlesArray = [];
    
    // Particle colors - ensure these match your desired theme
